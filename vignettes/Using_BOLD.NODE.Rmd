...
This vignette demonstrates a complete workflow integrating the *search*, *collect*, *get_* and *bcdm_to* functions in `BOLD.NODE` for efficient and scalable exploration of BOLD data packages. 
...
#### 7a. Obtaining a base level proportion in the sequences (using external package `Biostrings`)
...
### 8. Generate a `sf` object for spatial mapping of occurrences of the genus *Monochamus*ß
```{r sf_object}
