...
The user manual for the package can be downloaded from the following link (<https://github.com/boldsystems-central/BOLDconnectR_examples/blob/main/BOLD.NODE_0.0.3.pdf>)
