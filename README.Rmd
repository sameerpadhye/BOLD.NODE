...
5.  *Optional*: Generate concise summary and/or BIN centric summaries of the searched data based on various parameters (taxonomy, attributions, sequence meta data) (The *get_* functions).
